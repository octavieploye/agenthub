...
const createTaskSchema = z.object({
  ...
  providerOverride: z.enum(['anthropic', 'ollama-local', 'ollama-cloud', 'openai-codex']).optional(),
...
const updateTaskSchema = z.object({
  ...
  providerOverride: z.enum(['anthropic', 'ollama-local', 'ollama-cloud', 'openai-codex']).nullable().optional(),
