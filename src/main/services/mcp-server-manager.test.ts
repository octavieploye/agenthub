...
// NOTE: McpIpcResponseFrame was previously imported from '../mcp-server/ipc/ipc-protocol'
// — that module was deleted with the old mcp-server/ directory. The type now lives in
// the shared types file alongside McpIpcRequest/Response.
import type { McpIpcResponseFrame } from '../../shared/types/mcp-server.types'
