    ...
    <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-20 bg-black/40" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center gap-2 px-3 py-2 border-b border-base-content/10">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-base-content/40 shrink-0">
          ...
          <input
            ...
            className="flex-1 bg-transparent text-sm text-base-content outline-none placeholder:text-base-content/30"
          />
          <span className="text-[10px] text-base-content/30">Enter to search</span>
        </div>
