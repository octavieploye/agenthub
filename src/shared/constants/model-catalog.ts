...
export const OLLAMA_CLOUD_MODELS: ModelCatalogEntry[] = [
  ...
  { id: 'devstral-2:123b-cloud',      name: 'Devstral 2 123B',       provider: 'ollama-cloud', category: 'coding',   contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'devstral-small-2:24b-cloud', name: 'Devstral Small 2 24B',  provider: 'ollama-cloud', category: 'coding',   contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'qwen3-coder:480b-cloud',     name: 'Qwen3 Coder 480B',      provider: 'ollama-cloud', category: 'coding',   contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'qwen3.5:397b-cloud',         name: 'Qwen3.5 397B',          provider: 'ollama-cloud', category: 'mixed',    contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'qwen3-coder-next:q8_0',      name: 'Qwen3 Coder Next Q8',   provider: 'ollama-cloud', category: 'coding',   contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'qwen3-vl:235b-instruct-cloud', name: 'Qwen3 VL 235B',      provider: 'ollama-cloud', category: 'mixed',    contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'qwen3-next:80b-cloud',       name: 'Qwen3 Next 80B',        provider: 'ollama-cloud', category: 'mixed',    contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'gpt-oss:120b-cloud',         name: 'GPT OSS 120B',          provider: 'ollama-cloud', category: 'mixed',    contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'gpt-oss:20b-cloud',          name: 'GPT OSS 20B',           provider: 'ollama-cloud', category: 'mixed',    contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'gemma3:27b-cloud',           name: 'Gemma3 27B',            provider: 'ollama-cloud', category: 'mixed',    contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'gemini-3-flash-preview:cloud', name: 'Gemini 3 Flash Preview', provider: 'ollama-cloud', category: 'mixed', contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'cogito-2.1:671b-cloud',      name: 'Cogito 2.1 671B',       provider: 'ollama-cloud', category: 'thinking', contextWindow: 128000, available: true, supportsEffort: false },
  ...
  { id: 'minimax-m2:cloud',           name: 'MiniMax M2',            provider: 'ollama-cloud', category: 'mixed',    contextWindow: 128000, available: true, supportsEffort: false },
  { id: 'minimax-m2.1:cloud',         name: 'MiniMax M2.1',          provider: 'ollama-cloud', category: 'mixed',    contextWindow: 128000, available: true, supportsEffort: false },
  ...
  { id: 'nemotron-3-nano:30b-cloud',  name: 'Nemotron 3 Nano 30B',   provider: 'ollama-cloud', category: 'mixed',    contextWindow: 128000, available: true, supportsEffort: false },
